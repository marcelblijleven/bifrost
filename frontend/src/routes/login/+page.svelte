	...
	<div class="w-full max-w-sm">
		...
		<div class="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-8">
			...
			<form method="POST" use:enhance class="space-y-4">
				...
				<button
					type="submit"
					class="w-full rounded-lg bg-brand-500 px-4 py-2 text-sm font-semibold text-white transition hover:bg-brand-300 focus:outline-none focus:ring-2 focus:ring-brand-300 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-zinc-900"
				>
					Sign in
				</button>
			</form>
